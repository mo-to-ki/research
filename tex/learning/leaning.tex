...
$$
と書き換えられる。\\
$h = g_{\mu \upsilon}\dot{x}^{\upsilon}  \dot{x}^{\upsilon}$とおくと
\begin{eqnarray*}
...
\section{
	シュワルツシルト時空における測地線の予測
}
\begin{multicols}{2}
\includegraphics[width=0.9\columnwidth]{./images/schwarzschild/01.png}\\
\includegraphics[width=0.9\columnwidth]{./images/schwarzschild/02.png}\\
\end{multicols}
